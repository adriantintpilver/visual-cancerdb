...
In this initial stage it is uploaded to the AWS instance --> http://ec2-54-207-95-245.sa-east-1.compute.amazonaws.com/ but it is not available 100% of the time.
